...
┗━━━━┻┛╋┗┻┛╋┗━┻┛╋┗━┛
   ...
   ┗━━━┻━━━┻━━━┻━━━┛
       ...
       \033[35m𝑴𝒚 𝑻𝒆𝒂𝒎 : 𝑪𝒚𝒃𝒆𝒓 𝑻𝒂𝒏𝒈𝒆𝒓𝒂𝒏𝒈 𝑻𝒆𝒂𝒎
   \033[37m𝑾𝒆𝒍𝒄𝒐𝒎𝒆 : 𝑻𝒐𝒐𝒍𝒔 𝑫𝒅𝒐𝒔 𝒁𝒂𝒏𝒏
    \033[35m𝑴𝒆𝒔𝒔𝒂𝒈𝒆 : 𝑻𝒐𝒐𝒍𝒔 𝑫𝑫𝑶𝑺 𝑾𝒆𝒃𝒔𝒊𝒕𝒆🥶
    
「Ｌａｙｅｒ-７ 』

➣ .ʜᴛᴛᴘ-ʀᴀɴᴅᴏᴍ-ᴠ2
➣ .ᴄғ-ʙʏᴘ : ʙʏᴘᴀss ᴜᴀᴍ ᴄᴀᴘᴄᴛʜᴀ ᴄʟᴏᴜᴅ ғʟᴀʀᴇ
➣ .ʜᴛᴛᴘs-sᴘᴏᴏғ : ʜᴛᴛᴘs sᴘᴏᴏғ ᴀᴛᴛᴄᴋ ᴡᴇʙ
➣ .ᴏᴠᴇʀғʟᴏᴡ : ᴀᴛᴛᴀᴄᴋ ғᴏʀᴍ ʀᴀᴡ
➣ .ᴄʀᴀsʜ : ᴄʀᴀsʜ ᴡᴇʙ
➣ .ɴᴇᴡ : ᴍᴇᴛᴏᴅ ʜᴛᴛᴘs ɴᴇᴡ
➣ .ᴡᴏʟғ-ᴘᴀɴᴇʟ : ʀᴜɴ ᴡᴏʟғ ᴘᴀɴᴇʟ ᴠ1.0
➣ .ᴢᴀɴɴ-ᴅᴅᴏs : ᴀᴛᴛᴀᴄᴋ ғᴏʀᴍ ʀᴀᴡ
➣ .ᴛᴄᴘ-ᴋɪʟʟᴇʀ : ᴛᴄᴘ ᴋɪʟʟᴇʀ ᴀᴛᴛᴀᴄᴋ ᴡᴇʙ
➣ .ᴄғsᴛʀᴏɴɢ : ᴀᴛᴛᴀᴄᴋ What ᴠᴇʀʏ sᴛʀᴏɴɢ
➣ .ɴᴜʟʟ : ᴀᴛᴛᴀᴄᴋ ᴡᴇʙ ᴘᴏʀᴛ 443 80
➣ .ɴᴜᴋᴇ : ᴀᴛᴛᴀᴄᴋ ᴡᴇʙ  ғᴜʟʟ  ᴘᴏᴡᴇʀ⚡
➣ .ғʟᴏᴏᴅ : ᴀᴛᴛᴀᴄᴋ ᴛᴇsᴛ ғʟᴏᴏᴅ ☠️
➣ .sᴘɪᴋᴇ : ᴀᴛᴛᴀᴄᴋ ᴡᴇʙ sᴘɪᴋᴇ💥
➣ .ʙʏᴘᴀss : ʙʏᴘᴀss ᴄʟᴏᴜᴅ ғʟᴀʀᴇ
➣ .ᴋɪʟʟᴇʀ : ᴍᴏᴅᴇ ᴋɪʟʟᴇʀ
➣ .ᴛʟs : ᴠᴠɪᴘ ᴛʟs ᴢᴀɴɴ ᴄʏʙᴇʀ
➣ .ʜᴛᴛᴘ-ᴅᴅᴏs
➣ .ᴘsǫʟɪ : ᴘsǫʟɪ ᴡᴇʙ ɪɴᴊᴇᴄᴛɪᴏɴ

ᴍᴇssᴀɢᴇ : ᴊᴀɴɢᴀɴ sᴀʟᴀʜ ɢᴜɴᴀᴋᴀɴ sᴄ ɪɴɪ, ᴋᴀʀɴᴀ sᴀʏᴀ ᴛɪᴅᴀᴋ ʙᴇʀᴛᴀɴɢɢᴜɴɢ ᴊᴀᴡᴀʙ ᴊɪᴋᴀ sᴄ ᴅɪ sᴀʟᴀʜ ɢᴜɴᴀᴋᴀɴ. 
------------------------------------------------
...
def login():
    ...
    if username != user or password != passwd:
        ...
        print("🚀 Welcome to ZANN CYBER STRESSER!")
        main()
